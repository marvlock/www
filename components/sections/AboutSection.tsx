          ...
          >
            <div className="relative w-full h-full">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="relative w-64 h-64 rounded-full bg-gradient-to-br from-white/10 via-purple-500/20 to-blue-500/20 backdrop-blur-sm border border-white/10 shadow-2xl">
