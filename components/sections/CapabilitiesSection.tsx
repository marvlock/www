      ...
      <div className="container mx-auto max-w-4xl">
        ...
        >
          ...
          >
            ...
            <div className="relative p-8 md:p-12 lg:p-16 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm">
              <div className="text-lg md:text-xl lg:text-2xl text-[#94A3B8] leading-relaxed md:leading-relaxed text-center space-y-6">
                <p className="text-xl md:text-2xl lg:text-3xl text-white font-medium leading-tight mb-6">
